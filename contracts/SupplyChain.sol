...
contract SupplyChain {
  ...
  modifier forSale(uint _sku) {
    ...
    require(items[_sku].state == State.ForSale, "The item is not on sale!");
    _;

  }

  modifier sold(uint _sku) {
    require(items[_sku].state == State.Sold, "The item is not sold yet!");
    _;
  }

  modifier shipped(uint _sku) {
    require(items[_sku].state == State.Shipped, "The item is not shipped yet!");
    _;
  }
